...
export default function SpacesComeAlive() {
    ...
    const handleTouchMove = useCallback((e: TouchEvent) => {
        if (!isDragging) return;
        // Don't prevent default on touch move universally, causes scrolling issues
        // Just handle the slider if we're actively touching it
                ...
                <div className="slider-wrapper">
                    ...
                    >
                        ...
                        <div className="slider-image-before">
                            <img src="/images/Before.svg" alt="Before" className="slider-img" />
                        ...
                        >
                            ...
                            <div className="slider-handle-button">
                                <svg width="80" height="80" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M10 16L6 12L10 8" stroke="#004d5a" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                    <path d="M14 16L18 12L14 8" stroke="#004d5a" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                </svg>
                            </div>
                        </div>
                    </div>
