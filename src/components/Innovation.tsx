...
const callouts = [
    {
        ...
        line: { width: '80px', height: '100px', top: '100%', left: '50%', borderLeft: '1px solid #005A64', borderBottom: '1px solid #005A64', borderBottomLeftRadius: '0px' },
    ...
    },
    {
        ...
        line: { width: '1px', height: '80px', top: '100%', left: '50%', backgroundColor: '#005A64' },
    ...
    },
    {
        ...
        line: { width: '1px', height: '60px', top: '100%', left: '50%', backgroundColor: '#005A64' },
    ...
    },
    {
        ...
        line: { width: '80px', height: '60px', top: '50%', right: '100%', borderBottom: '1px solid #005A64', borderLeft: '1px solid #005A64', borderBottomLeftRadius: '0px', transform: 'translateY(-100%)' },
    ...
    },
    {
        ...
        line: { width: '60px', height: '1px', top: '50%', right: '100%', backgroundColor: '#005A64' },
    ...
    },
    {
        ...
        line: { width: '80px', height: '60px', bottom: '100%', left: '20%', borderTop: '1px solid #005A64', borderLeft: '1px solid #005A64', borderTopLeftRadius: '0px' },
    ...
    },
    {
        ...
        line: { width: '1px', height: '80px', bottom: '100%', left: '50%', backgroundColor: '#005A64' },
    ...
    },
    {
        ...
        line: { width: '80px', height: '50px', bottom: '100%', right: '20%', borderTop: '1px solid #005A64', borderRight: '1px solid #005A64', borderTopRightRadius: '0px' },
    ...
    },
    {
        ...
        line: { width: '60px', height: '1px', top: '50%', left: '100%', backgroundColor: '#005A64' },
        ...
        <section className="innovation-section">
            <div className="innovation-container">
                ...
                <div className="innovation-diagram-area">
                    ...
                    {/* Callout Cards & Lines (Desktop only typically, but we'll adapt for mobile later) */}
                    <div className="callouts-layer">
                        {callouts.map((callout) => (
                            <React.Fragment key={callout.id}>
                                <div
                                    className="callout-card"
                                    style={{ top: callout.position.top, left: callout.position.left, transform: 'translate(-50%, -50%)' }}
                                >
                                    <h4 className="callout-title">{callout.title}</h4>
                                    <p className="callout-desc">{callout.description}</p>

                                    {/* The connecting line SVG could go here, or simple CSS lines */}
                                    {/* For complexity of angled lines, we use a mix of CSS borders or pseudo elements */}
