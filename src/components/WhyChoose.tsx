...
const reasons = [
    ...
    },
    {
        ...
        // subtitle: 'WiWA CERTIFIED SAFETY',
...
const IconCheck = () => (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="check-icon">
        <rect width="20" height="20" x="2" y="2" rx="4" fill="rgba(255, 255, 255, 0.15)" />
        <path d="M7 12L10.5 15.5L18 8" stroke="#3b82f6" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
);
...
export default function WhyChoose() {
    ...
    const handleScroll = () => {
        ...
        const cardWidth = container.offsetWidth; // Assuming roughly 1 visible card per view for dot alignment

        // Calculate which card is currently mostly in view
        const newIndex = Math.round(scrollPosition / cardWidth);
        if (newIndex !== activeIndex && newIndex >= 0 && newIndex < reasons.length) {
                            ...
                            <div className="card-header">
                                <div className="card-header-logo-container">
                                    <img
                                        ...
                                        width={reason.id === 'sustainability' || reason.id === 'care' ? "228.88" : "133.33"}
                                        height={reason.id === 'sustainability' || reason.id === 'care' ? "49.9" : "50"}
                                    />
